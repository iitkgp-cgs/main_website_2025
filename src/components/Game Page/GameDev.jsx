...
const GameDev = () => {
  ...
  const Game2D = [
    ...
    { id: 4, name: 'Chrono-chrome', image: 'https://res.cloudinary.com/dodlxtpvx/image/upload/v1738503328/Screenshot_2025-02-02_at_7.02.50_PM_yhycws.png', creator: 'Harshwardhan Walunjkar', linkedin: 'https://www.linkedin.com/in/harshwardhan-walunjkar-93035628b/' ,play:'https://harshuiuiui.itch.io/chrono-chrome' , description:'Collect colors to pass lasers, grab all purple orbs, and reach the goal. Rewind time or use a clone to solve 5 levels!', video:'https://res.cloudinary.com/dodlxtpvx/video/upload/v1738503681/REC-20250202190931_epqqtr.mp4'},
    { id: 9, name: "Warriors's Quest", image: "https://res.cloudinary.com/dodlxtpvx/image/upload/v1742408956/icon_tzj7xk.png", creator : "Navnihal Satpute", linkedin: "https://www.linkedin.com/in/navnihal-satpute", play: 'https://drive.google.com/drive/folders/1z9GveIIAUW7vAb5byp7Tu2RUiVnrwlrB', description: "Warrior's Quest is an engaging 2D platformer that combines maze puzzles, intense sword-fighting combat, and thrilling parkour challenges. Players navigate through intricate mazes filled with enemies, using their sword-fighting skills to defeat foes and overcome obstacles. The game tests agility and strategy as players leap across platforms, solve puzzles, and battle their way to victory in a quest for glory.", video: "https://res.cloudinary.com/dodlxtpvx/video/upload/v1742409498/Copy_of_trailer_bqlyqc.mp4"}
  ];
  const Game3D = [  
        ...
        { id: 5,name: "Project ZRH",image: "https://img.itch.zone/aW1hZ2UvMjU2NTA5My8xNTI5OTM1NS5wbmc=/original/iF%2B%2Fmr.png",creator: "Raaja Das",linkedin: "https://www.linkedin.com/in/raaja-das-92797026a/",play: "https://computer-graphics-society.itch.io/project-zrh",description: "A fast-paced zombie survival game—scavenge, fight hordes, and uncover the outbreak’s secrets. Stay sharp, stay alive!",video: "https://img.itch.zone/aW1hZ2UvMjU2NTA5My8xNTI5OTM1NS5wbmc=/original/iF%2B%2Fmr.png"},
        { id: 10, name: "Prop Hunt", image: "https://res.cloudinary.com/dodlxtpvx/image/upload/v1742410000/250320_00h16m01s_screenshot_bbqs8c.png", creator: "Himesh Kundal, Abyan hussain", linkedin: "https://www.linkedin.com/in/himesh-kundal-140059287/", play: "IN DEV", description: "Prop Hunt is a thrilling multiplayer game where players take on the roles of hunters or props. Props disguise themselves as everyday objects in the environment, blending in to avoid detection, while hunters must uncover and eliminate them. The game combines strategy, stealth, and quick thinking, creating an exciting and fast-paced hide-and-seek experience.", video: "https://res.cloudinary.com/dodlxtpvx/video/upload/v1742409995/Unreal_Engine_5_HineNSeek_1_ygug5a.mp4" },
      ];
